...
9. add or change these files with contents from below:

- web-ui-components/tsconfig.base.json
- web-ui-components/packages/tsconfig.package.json <<< check v
...
- web-ui-components/packages/ui-solid/src/index.ts <<< check v (ook andere index.ts?)
- web-ui-components/packages/shared/package.json <<< check v
- web-ui-components/packages/shared/tsconfig.build.json <<< check v
- web-ui-components/packages/shared/build/prepare-css.mjs
- web-ui-components/packages/shared/src/index.ts <<< check v
...
10. remove these files and directories:
...
11. add empty web-ui-components/packages/shared/styles/index.css
12. web-ui-components: npm install
13. web-ui-components: npm run build
14. web-ui-components: npm run dev:solid
...
```
{
  ...
  "scripts": {
    "build": "node build/prepare-css.mjs",
